...
couch = couchdb.Server('http://admin:estopinalgui@129.114.26.92:5984/')
db = couch.create('project1np')
# We can make this more sophisticated/elegant but for now it is just
# hardcoded to the setup I have on my local VMs

# acquire the consumer
# (you will need to change this to your bootstrap server's IP addr)
consumer = KafkaConsumer (bootstrap_servers="129.114.25.218:9092")
...
for msg in consumer:
    ...
    doc[str(time.time())]=str(msg.value, 'ascii')
